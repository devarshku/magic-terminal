# Generated by Powerlevel10k configuration wizard on 2026-03-20 at 11:13 CET.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=216
  ...
  # Background color (THIS is what you want)
  typeset -g POWERLEVEL9K_USER_BACKGROUND=224  

  # Text color
  typeset -g POWERLEVEL9K_USER_FOREGROUND=0     

  # Always show user (even if not root)
  #typeset -g POWERLEVEL9K_USER_{DEFAULT,SUDO}_CONTENT_EXPANSION='%n'
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=111
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=151
...
# Force seperation for colors not to look blended
typeset -g POWERLEVEL9K_USER_LEFT_SEGMENT_END_SYMBOL=$'\uE0B0'
